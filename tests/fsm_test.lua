...
local initialization_subs= {
 {target="172.16.185.131/lupa/rmoon", command="watch_mib", mib="process_running", process="top",
	op=">", value=0.5, hysteresis=0.05, notification_id="watchingtop1", watcher_id="toprunning"},	
 {target="172.16.185.131/lupa/rmoon", command="watch_mib", mib="process_running", process="top",
	op="=", value=0, hysteresis=0.05, notification_id="watchingtop2", watcher_id="topnotrunning"}	
}
...
local function action_runing()
	print ("RUNING!") 
	return {
		{target="172.16.185.131/lupa/pep", command="route_add", notification_id="randomrandom4",
			targetNetworkIp="172.16.185.128", targetNetworkMaskBits="32", 
			gatewayIp="172.16.185.132", interface="eth0"},
		{target="172.16.185.128/lupa/pep", command="route_add", notification_id="randomrandom4",
			targetNetworkIp="172.16.185.131", targetNetworkMaskBits="32", 
			gatewayIp="172.16.185.132", interface="eth0"},
	}
end
local function action_not_runing()
	print ("NOT RUNING!") 
	return {
		{target="172.16.185.131/lupa/pep", command="route_delete", notification_id="randomrandom4",
			targetNetworkIp="172.16.185.128", targetNetworkMaskBits="32", 
			gatewayIp="172.16.185.132", interface="eth0"},
		{target="172.16.185.128/lupa/pep", command="route_delete", notification_id="randomrandom4",
			targetNetworkIp="172.16.185.131", targetNetworkMaskBits="32", 
			gatewayIp="172.16.185.132", interface="eth0"},
	}
end
